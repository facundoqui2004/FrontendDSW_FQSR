...
const Sidebar = (props) => {
  ...
  return (
    <div className={` bg-[#f1a035] fixed lg:left-0 top-0 w-28 h-full flex flex-col justify-between py-6 rounded-tr-xl rounded-br-xl z-50 transition-all duration-300 ease-in-out shadow-lg
    ${showMenu ? 'left-0' : '-left-full'}`}>
      <div className="text-center my-4 relative group">
            <img
                src="/public/Images/burocrataLogo.png" // reemplaza con la ruta real del logo
      ...
      <div>
        <ul className="pl-4">
            ...
            <a 
                href="#" 
                className="bg-[#f1a035] p-4 flex justify-center block rounded-xl text-white relative group"
            >
            ...
            <li className="hover:bg-[#f8d19d] p-4 block rounded-tl-xl rounded-bl-xl group transition-colors">
                <a
                    href="#"
                    className="group-hover:bg-[#f1a035] p-4 flex justify-center block rounded-xl text-white group-hover:text-white relative"
                >
